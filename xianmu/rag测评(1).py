...
def rags_evaluation():
    ...
    test_data = [
        ...
        {
            "question": "乾隆皇帝在盘山说了什么诗？",
            "ground_truth": "早知有盘山，何必下江南"
        },
        {
            "question": "故宫什么时候建成的",
        ...
        {
            "question": "郦道元《水经注》云说了盘山什么？",
            "ground_truth": "盘山水，水出山上，去山三十里，望山上水可高二十里，素湍浩然，颓波历谷，沿流而下”未见泉水便闻响涧，原来这就是涓涓泉，走到前去，手捧一把甘液，水质凛冽甘美。"
        },
        {
            "question": "黄崖关是哪个朝代建成的",
            "ground_truth": "7959年"
        },
        {
            "question": "颐和园占地有多大？",
